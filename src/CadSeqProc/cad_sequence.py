        ...
        if self.operation_order:
            for op in self.operation_order:
                ...
                if op["type"] == "extrude":
                    ...
                    self.flag_vec.extend([SKETCH_FLAG] * len(skt_vec))
                    self.index_vec.extend([sketch_idx + 1] * len(skt_vec))
                    
                    # 添加拉伸向量
                    self.cad_vec.extend(ext_vec)
                    self.flag_vec.extend([1] + list(range(1, 11)))
                    self.index_vec.extend([sketch_idx + 1] * len(ext_vec))
                    ...
                    self.flag_vec.extend([11] + list(range(11, 28)))
                    self.index_vec.extend([sketch_idx + 1] * len(rev_vec))

...
from src.dataset.CadSeqProc.utility.macro import N_BIT, EXTRUDE_FLAG_START, EXTRUDE_FLAG_RANGE, REVOLVE_FLAG_START, REVOLVE_FLAG_RANGE, PADDING_FLAG
from src.dataset.CadSeqProc.utility.utils import ensure_dir, get_files_scan

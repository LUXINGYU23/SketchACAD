...
from src.dataset.CadSeqProc.utility.utils import dequantize_verts, int_round, quantize, float_round
from loguru import logger
from src.dataset.CadSeqProc.sequence.sketch.coord_system import CoordinateSystem
...
class RevolveSequence(object):
    ...
    def visualize_revolve_setup(self, sketch_face, axis_start_array, axis_end_array, angle):
        ...
        try:
            ...
            from OCC.Core.BRepAdaptor import BRepAdaptor_Surface
            from src.dataset.CadSeqProc.utility.utils import create_point_from_array
            import math

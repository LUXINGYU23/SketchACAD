...
class CoordinateSystem(object):
    ...
    def numericalize(self, bit: int):
        ...
        """
        # clglogger.debug(
        #     f"Original coordinatesystem metadata: {self.metadata}"
        # )
        ...
        # clglogger.debug(
        #     f"Numericalized coordinatesystem metadata: {self.metadata}"
        # )
    def denumericalize(self, bit):
        ...
        # clglogger.debug(
        #     f"Denumericalized coordinatesystem metadata: {self.metadata}"
        # )
        self.is_numerical = False

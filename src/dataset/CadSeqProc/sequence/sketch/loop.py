...
from src.dataset.CadSeqProc.geometry.arc import Arc
from src.dataset.CadSeqProc.geometry.circle import Circle
...
class LoopSequence(object):
    ...
    def from_vec(vec, bit, post_processing, fix_collinearity):
        ...
        # clglogger.debug(f"Vec: {vec}")
        # clglogger.debug(f"Merged Vec: {merged_vec}")

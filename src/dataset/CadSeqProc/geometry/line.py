...
class Line(Curve):
    ...
    def to_vec(self):
        ...
        # clglogger.debug(
        #     f"Line to_vec: {coord_token} Start Point: {self.metadata['start_point']} End Point: {self.metadata['end_point']}"
        # )
        return coord_token
    ...
    def from_vec(vec, bit=N_BIT, post_processing=False):
        ...
        line.bit = bit
        # clglogger.debug(
        #     f"Line from_vec: {vec} Start Point: {line.metadata['start_point']} End Point: {line.metadata['end_point']}"
        # )
        return line
